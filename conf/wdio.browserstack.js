...
exports.config = {
    ...
    capabilities: [{
        browserName: 'ie',
        version: '10',
        platform: 'WINDOWS', // WINDOWS|XP|VISTA|MAC|LINUX|UNIX|ANDROID
        name: 'browserstack-ie',
        build: 'webdriver-browserstack',
        'browserstack.local': true
    // }, {
    //     browserName: 'chrome',//     
    //     version: '53.0',
    //     platform: 'MAC', // WINDOWS|XP|VISTA|MAC|LINUX|UNIX|ANDROID
    ...
    onComplete: function(exitCode) {
        console.log('BrowserStack testing complete');
        exports.bsLocal.stop(function() {});
    }
}
